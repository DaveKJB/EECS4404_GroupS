...
equation = f"Rank = {regr.intercept_} + {regr.coef_[0]} * GPA + {regr.coef_[1]} * SAT"
print()
print(f"Linear Regression Equation: {equation}")
print()
print('close the graph and input new GPA and SAT for predicted Ranking')
...
legend_entry = Line2D([0], [0], marker='o', color='w', label='Students', markerfacecolor='blue', markersize=8)
...
# Show the plot
plt.title('Predict Ranking of Schools by GPA an SAT scores')
plt.show()
